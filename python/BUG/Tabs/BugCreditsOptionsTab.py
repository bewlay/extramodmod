...
credits = [ 
			"-", "Fall from Heaven|Fall from Heaven II Team",
			...
			"-",
			"-", "ExtraModMod developers",
			"lfgr - BarbsPlus, Events enhanced, Extra civilization traits, fixes, feedback, reviews of proposals",
			"Terkhen - Lead developer",
			"-",
			"-", "ExtraModMod contributions",
			...
			"Karadoc - Many bugfixes and UI improvements",
			...
			"Realism Invictus team - Makefile, leader traits",
			"Rise from Erebus team - Resources, traits, leaders, spells, buildings, Adventurer Counter, CivCounter, Civilization specific modifications to terrain yields, new unique features",
			"Rystic - Wonder changes, race changes, civilization changes",
			"Sareln - Erebus in the Balance (included nearly completely in ExtraModMod)",
			"scutarii - Suggestions, feedback, civic changes",
			"TaSSeRD - Testing, feedback, suggestions",
			"Tasunke - Feedback, suggestions, reviews of proposals, civic changes, tech changes, wonder changes",
			...
			"[to_xp]Gekko - Feedback, suggestions, review of proposals of new features, starting leader traits, unit tweaks, spell tweaks, changes to starting civics",
			"xienwolf - Civilization specific modifications to terrain yields",
			"-",
			"-", "Events Enhanced",
			"lfgr - Adaptation to MNAI, integration of event mods, fixes and improvements",
			"ostar - FFH More Events Expanded, Events with Images, World Unit popups, Great Person Mod",
			"Black_Imperator - FFH More Events Modmod",
			"xienwolf - Great Person Mod",
			"MagisterCultuum - Additions and changes ported to Events Enhanced",
			"Sephi - Bug fixes included in FFH More Events Expanded",
			"-",
			"-", "MapScripts",
			"Discworld - Terkhen",
			"Earth3 - Sirian, GRM7584, jkp1187, Temudjin, Terkhen",
			"Erebus - cephalo, Temudjin, Terkhen",
			"ErebusContinent - Seven05, cephalo",
			"FracturedWorld - Temudjin, Terkhen",
			"InlandSea - Sirian, Soren Johnson, Andy Szybalski, Temudjin, Terkhen",
			"Medium_and_Small - Sirian, Temudjin, Terkhen",
			"MountainCoast - lonkero173",
			"PerfectWorld2 - cephalo, Temudjin, Terkhen",
			"PlanetFall - Maniac, Oleg Giwodiorow / Refar, Temudjin, Terkhen",
			"Ringworld - Ruff_Hi, Temudjin, Terkhen",
			"RandomMap - Terkhen",
			"SeaHighlands - Sirian, vbraun, Temudjin, Terkhen",
			"SmartMap - Doug McCreary, Keldath, Mrgenie, TAfirehawk, Temudjin",
			"Tectonics - LDiCesare, Temudjin, Terkhen",
			"WorldOfErebus - Seven05, cephalo",
			"-",
