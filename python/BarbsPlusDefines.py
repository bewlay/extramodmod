...
def getAnimalValue( eUnitType ) :
	...
	if( liAnimalValues == None ) :
		...
		liAnimalValues[gc.getInfoTypeForString( "UNIT_BOAR" )] = 15
		...
		liAnimalValues[gc.getInfoTypeForString( "UNIT_HYENA" )] = 15
		liAnimalValues[gc.getInfoTypeForString( "UNIT_LION" )] = 15
		liAnimalValues[gc.getInfoTypeForString( "UNIT_LION_PRIDE" )] = 20
		liAnimalValues[gc.getInfoTypeForString( "UNIT_LIZARD_GREAT" )] = 15
		liAnimalValues[gc.getInfoTypeForString( "UNIT_LIZARD_GIANT" )] = 25
